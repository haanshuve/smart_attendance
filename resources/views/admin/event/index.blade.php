...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary shadow" data-bs-toggle="modal" data-bs-target="#modalEvent">
            + Buat Acara Baru
        </button>
    </div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge
                            {{ $e->status_event == 'ongoing' ? 'bg-success' :
                               ($e->status_event == 'planned' ? 'bg-primary' : 'bg-secondary') }}">
                    ...
                    <td>
                        <!-- 🔥 TOMBOL UTAMA -->
                        <a href="/event/{{ $e->id_event }}/peserta"
